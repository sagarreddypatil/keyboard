...
// Device Descriptors
//--------------------------------------------------------------------+
static const tusb_desc_device_t desc_device = {.bLength = sizeof(tusb_desc_device_t),
...
static const uint8_t desc_hid_report[] = {TUD_HID_REPORT_DESC_KEYBOARD(HID_REPORT_ID(0x01))};
...
#error tried to use USB high speed
#endif
...
const char *string_desc_arr[] = {
    ...
    "PLACEHOLDER",              // 3: Serials, should use chip ID
};
